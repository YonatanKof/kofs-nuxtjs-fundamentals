<template>
	<div class="three-d-group">
		...
		<fieldset class="pers-form">
			<label v-if="showCompPres" class="pers-form__label" for="perspective"
				>Station Point
				<input
			...
			<label v-if="showGridLineY" class="pers-form__label" for="grid-line-y"
				>Ground Plane
				<input
					class="pers-form__input"
					id="grid-line-y"
...
export default {
	...
	props: ['showCompPres', 'showCompScale', 'showCompRotY', 'showCompAxleY', 'showGridLineY'],
	data() {
		return {
			compPres: 55,
			compRotY: 320,
